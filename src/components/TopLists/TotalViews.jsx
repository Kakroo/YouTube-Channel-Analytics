    ...
    <div className='flex justify-center dark:bg-black dark:text-white px-28 py-16  '>
        ...
        <div className='border-2 rounded-lg'>
            ...
            <div >
                ...
                <NavLink to='/movieclips'>
                    <div className='flex mt-2  py-2 justify-between border-b-2 items-center'>
                        <div className='pl-8 flex justify-center pr-12'>8</div>
                        <div className='flex pl-0 w-64   justify-start pr-12'>
                            <div className=''>
                                <img className='border-2 h-12 rounded-md' src="public\images\channels28_profile.jpg" alt="" />
                            </div>
                            <div className='ml-4'>
                                <div className='text-sm m-0 p-0'>Movieclips</div>
                                <span className='m-0 p-0 text-gray-400 text-xs' >@movieclips</span>
                                
                            </div>
                        </div>
                        <div className='px-12'>62.1B</div>
                        <div className='px-10'>61.3M</div>
                        <div className='px-12'>40.6K</div>
                    </div>
                </NavLink>
                <NavLink to='/netdmuzik'>
                    <div className='flex mt-2  py-2 justify-between border-b-2 items-center'>
                        <div className='pl-8 flex justify-center pr-12'>9</div>
                        <div className='flex pl-0 w-64   justify-start pr-12'>
                            <div className=''>
                                <img className='border-2 h-12 rounded-md' src="public\images\channels29_profile.jpg" alt="" />
                            </div>
                            <div className='ml-4'>
                                <div className='text-sm m-0 p-0'>netd müzik</div>
                                <span className='m-0 p-0 text-gray-400 text-xs' >@netdmuzik</span>
                                
                            </div>
                        </div>
                        <div className='px-12'>60.8B</div>
                        <div className='px-10'>25.3M</div>
                        <div className='px-12'>25.5K</div>
                    </div>
                </NavLink>
                
                <NavLink to='/abscbnent'>
                    <div className='flex mt-2  py-2 justify-between border-b-2 items-center'>
                        <div className='pl-8 flex justify-center pr-12'>10</div>
                        <div className='flex pl-0 w-66 justify-start pr-14'>
                            <div className=''>
                                <img className='border-2 h-12 rounded-md' src="public\images\channels30_profile.jpg" alt="" />
                            </div>
                            <div className='ml-3'>
                                <div className='text-sm m-0 p-0'>ABS-CBN Entertainment</div>
                                <span className='m-0 p-0 text-gray-400 text-xs' >@abscbnentertainment</span>
                                
                            </div>
                        </div>
                        <div className='px-12'>54.8B</div>
                        <div className='px-10'>47.9M</div>
                        <div className='px-12'>224K</div>
                    </div>
                </NavLink>
