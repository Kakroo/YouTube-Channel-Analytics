            ...
            <div >
                ...
                <NavLink to='/movieclips'>
                    <div className='flex mt-2  py-2 justify-between border-b-2 items-center'>
                        ...
                        <div className='flex pl-0 w-64   justify-start pr-12'>
                            <div className=''>
                                <img className='border-2 h-12 rounded-md' src="/images/channels28_profile.jpg" alt="" />
                            </div>
                            <div className='ml-4'>
                ...
                <NavLink to='/netdmuzik'>
                    <div className='flex mt-2  py-2 justify-between border-b-2 items-center'>
                        ...
                        <div className='flex pl-0 w-64   justify-start pr-12'>
                            <div className=''>
                                <img className='border-2 h-12 rounded-md' src="/images/channels29_profile.jpg" alt="" />
                            </div>
                            <div className='ml-4'>
                ...
                <NavLink to='/abscbnent'>
                    <div className='flex mt-2  py-2 justify-between border-b-2 items-center'>
                        ...
                        <div className='flex pl-0 w-66 justify-start pr-14'>
                            <div className=''>
                                <img className='border-2 h-12 rounded-md' src="/images/channels30_profile.jpg" alt="" />
                            </div>
                            <div className='ml-3'>
