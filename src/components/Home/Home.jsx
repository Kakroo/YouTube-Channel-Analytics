        ...
        <div className="mx-auto w-full  max-w-3xl">
            ...
            <div className='flex mt-16 justify-between  items-center px-4 py-5 shadow-lg rounded-md border-2 max-sm:mx-4 border-gray-100'>
                <div className=' max-sm:hidden flex items-center mr-4 ml-6'>
                    <div>
                        <img className=' flex-shrink-0 w-12 rounded-full h-12 object-fill border-2  border-blue-400' src="public\images\channels3_profile.jpg" alt="" />
                    </div>
                ...
                <div className=' max-sm:hidden flex items-center ml-3'>
                    <div>
                        <img className='flex-shrink-0 w-12  rounded-full h-12 object-fill border-2 border-red-500' src="public\images\channels4_profile.jpg" alt="" />
                    </div>
