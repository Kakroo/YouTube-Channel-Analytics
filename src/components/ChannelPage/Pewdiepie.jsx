            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="public\images\channels7_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-2xl font-bold'>PewDiePie</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@pewdiepie</div>
                                <div className=' text-sm ml-4 text-gray-400'>4,764 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>111,000,000</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>29,300,511,129
</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black  dark:bg-white dark:text-black'>#64</div>
