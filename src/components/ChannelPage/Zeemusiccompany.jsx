            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="public\images\channels8_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-2xl font-bold'>Zee Music Company</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@zeemusiccompany</div>
                                <div className=' text-sm ml-4 text-gray-400'>11,080 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>107,000,000</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>66,485,811,517
</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black  dark:bg-white dark:text-black'>#11</div>
                    ...
                    <div> 
                        ...
                        <div>
                            ...
                            <div className='mt-4 ml-4 px-6 py-1 border-t-2 '>
                                ...
                                <p>Zee Music Company is part of India's leading television media and entertainment companies. It is amongst the largest producers and aggregators of Hindi programming in the world, with an extensive library housing over 222,000 hours of television content along with a strong presence in over 171 countries and a total viewership of 1 Billion plus people around the globe. Our Library has rights to more than 3,818 movie titles from premiere studios featuring iconic film stars, ZEEL houses the world’s largest Hindi film library.</p>
                                <ul className='py-4'>
                                    <li>Zee Music Company</li>
                                    <li>Facebook - https://www.facebook.com/zeemusiccompany</li>
                                    <li>Twitter - https://twitter.com/ZeeMusicCompany</li>
                                </ul>
                            </div>
                        </div>
...
export default Zeemusiccompany
