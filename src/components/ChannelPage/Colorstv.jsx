            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="public\images\channels18_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-2xl font-bold'>Colors TV</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@colorstv</div>
                                <div className=' text-sm ml-4 text-gray-400'>149,547 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>72,600,000</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold  hover:text-white hover:bg-black hover:border-black dark:bg-white dark:text-black'>#21</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>70,525,909,326</div>
                    ...
                    <div> 
                        ...
                        <div>
                            ...
                            <div className='mt-4 ml-4 px-6 py-1 border-t-2 '>
                                ...
                                <p className='py-4'>Welcome to the official main channel of Colors TV!</p>

                                <ul className='pb-8'>
                                    <li>Show some love people by subscribing to our channel: http://www.youtube.com/user/colorstv?sub_confirmation=1</li>
                                    <li>Follow us on Google+: https://plus.google.com/108336806150063826507</li>
                                    <li>Follow us on Facebook: https://www.facebook.com/ColorsTV</li>
                                    <li>Follow us on Twitter: https://twitter.com/ColorsTV</li>
                                </ul>
