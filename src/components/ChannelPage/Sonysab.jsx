            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="public\images\channels12_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-2xl font-bold'>Sony SAB</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@sonysab</div>
                                <div className=' text-sm ml-4 text-gray-400'>85,174 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>92,100,000</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>114,657,103,885</div>
                    ...
                    <div> 
                        ...
                        <div className='flex justify-between'>
                            <div className='flex justify-evenly py-7'>
                                ...
                                <div className='shadow-lg rounded-md border-2 ml-4 text-center px-12 py-10  '>
                                    ...
                                    <div>IN</div> 
                                    <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black dark:bg-white dark:text-black'>#5</div>
                                </div>
                        ...
                        <div>
                            ...
                            <div className='mt-4 ml-4 px-6 py-1 border-t-2 '>
                                ...
                                <p>Official Account of Sony SAB, a leading Hindi GEC within Sony Pictures Networks. It’s the ‘Home of good content’         committed to diverse storytelling & evoking real emotions.</p>
                                <p>We believe in ‘Jo roz choti khushiya dete hai, wohi rishtey toh bade hote hai'</p>
                            </div>
                        </div>
