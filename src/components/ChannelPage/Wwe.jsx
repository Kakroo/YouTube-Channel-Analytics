            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="public\images\channels9_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-2xl font-bold'>WWE</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@wwe</div>
                                <div className=' text-sm ml-4 text-gray-400'>76,339 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>101,000,000</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold  hover:text-white hover:bg-black hover:border-black dark:bg-white dark:text-black'>#10</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>84,603,139,816
</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black  dark:bg-white dark:text-black'>#9</div>
                        ...
                        <div className='flex justify-between'>
                            <div className='flex justify-evenly py-7'>
                                ...
                                <div className='shadow-lg rounded-md border-2 ml-4 text-center px-12 py-10  '>
                                    ...
                                    <div>N/A</div> 
                                    <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black dark:bg-white dark:text-black'>N/A</div>
                                </div>
                        ...
                        <div>
                            <div className='flex justify-evenly text-center'>
                                ...
                                <div>
                                    ...
                                    <div className='font-semibold'>17 years</div>
                                </div>
                            </div>
                            <div className='mt-4 ml-4 px-6 py-1 border-t-2 '>
                                <p className='py-8 font-bold text-lg'>About</p>
                                <ul>
                                    <li className='py-4'>WWE on YouTube is your number one spot to catch WWE original shows and exclusives!</li>
                                    <li className='py-4'>Watch videos from all of your favorite WWE Superstars, backstage fallout from live shows including Raw, SmackDown, NXT and original shows such as Top 10, List This, WWE's The Bump and much more!</li>
                                    <li className='py-4'>Subscribe - https://goo.gl/2YO0Is</li>
                                    <li className='py-4'>Stream WWE on Peacock https://pck.tv/2PIAQJI in the U.S. and on WWE Network http://wwe.yt/wwenetwork everywhere else.</li>
                                </ul>
                            </div>
                        </div>
