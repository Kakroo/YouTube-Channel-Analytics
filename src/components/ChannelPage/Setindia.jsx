            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="public\images\channels6_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-2xl font-bold'>SET India</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@setindia</div>
                                <div className=' text-sm ml-4 text-gray-400'>137,178 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>172,000,000</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>164,045,981,503
</div>
                    ...
                    <div> 
                        ...
                        <div>
                            ...
                            <div className='mt-4 ml-4 px-6 py-1 border-t-2 '>
                                ...
                                <p>Sony Entertainment Television is one of the leading Hindi General Entertainment channels in India. Since its launch in October 1995, SET has created a unique space, in television programming, with movie premieres, fiction & non–fiction shows.
                                The Kapil Sharma Show, Shark Tank India, Kaun Banega Crorepati, Indian Idol, Bade Achhe Lagte Hain, Adaalat, CID, Crime Patrol and Super Dancer are some of the popular shows by Sony. Drama, suspense, romance & reality, you name and we have it all for you.</p>
                            </div>
                        </div>
