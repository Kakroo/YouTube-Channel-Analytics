            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="public\images\channels30_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-xl font-bold'>ABS-CBN Entertainment</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@abscbnentertainment</div>
                                <div className=' text-sm ml-4 text-gray-400'>224,098 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>47,900,000</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold  hover:text-white hover:bg-black hover:border-black dark:bg-white dark:text-black'>#54</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>54,752,652,789</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black  dark:bg-white dark:text-black'>#17</div>
                    ...
                    <div> 
                        ...
                        <div>
                            ...
                            <div className='mt-4 ml-4 px-6 py-1 border-t-2 '>
                                <p className='py-4 font-bold text-lg'>About</p>
                                <p>Watch your favorite entertainment shows from the leading television network!</p>
                                <p className='py-2'>Subscribe to ABS-CBN Entertainment channel! - https://bit.ly/ABS-CBNEntertainment</p>
                                
                                <p className='pt-4'>Visit our official websites!</p>
                                <p>https://entertainment.abs-cbn.com/tv/home</p>
                                <p>https://www.push.com.ph</p>
                                <p className='pt-4'>Facebook:</p>
                                <p>https://www.facebook.com/ABSCBNnetwork</p>
                                
                                <p className='pt-4'>Twitter:</p>
                                <p>https://twitter.com/ABSCBN</p>
                                

                                <p className='pt-4'>Instagram:</p>
                                <p>https://instagram.com/abscbn</p>
