            ...
            <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
                <div className='flex justify-between '>
                    <div className='flex items-center mr-10 '>
                        <div>
                            <img className='w-24 rounded-md' src="./src/assets/channels26_profile.jpg" alt="" />
                        </div>
                        <div className='ml-4'>
                            <div className='text-2xl font-bold'>I did a thing</div>
                            <div className='flex items-center'>
                                <div className=' text-gray-500'>@ididathing</div>
                                <div className=' text-sm ml-4 text-gray-400'>111 videos</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex items-center'>
                        <div className='mr-4 pr-6  text-center border-r-2 border-gray-400'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold  mr-2'>5,120,000</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold  hover:text-white hover:bg-black hover:border-black dark:bg-white dark:text-black'>#839</div>
                        ...
                        <div className='ml-4 text-center'>
                            ...
                            <div className='flex items-center mt-1.5'>
                                <div className='font-bold mr-2'>706,830,617</div>
                                <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black  dark:bg-white dark:text-black   '>#22,642</div>
                    ...
                    <div> 
                        ...
                        <div className='flex justify-between'>
                            <div className='flex justify-evenly py-7'>
                                ...
                                <div className='shadow-lg rounded-md border-2 ml-4 text-center px-12 py-10  '>
                                    ...
                                    <div>AU</div> 
                                    <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black dark:bg-white dark:text-black'>#45</div>
                                </div>
                                ...
                                <div className='shadow-lg rounded-md border-2 ml-4 text-center px-12 py-10  '>
                                    ...
                                    dark:bg-white dark:text-black'>#655</div>
                                </div>
                        ...
                        <div>
                            ...
                            <div className='mt-4 ml-4 px-6 py-1 border-t-2 '>
                                ...
                                <p>I like to do things so come watch me</p>
