...
// const API_KEY = 'AIzaSyBLoH0OKS9XovFCx6MSgUAgH_3Gy3b4hrA';
// document.getElementsByTagName('NavLink') 
...
//                                 <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold  hover:text-white hover:bg-black hover:border-black'>#2</div>
...
//                                 <div className=' ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black    '>#22</div>
...
const API_KEY = 'AIzaSyBLoH0OKS9XovFCx6MSgUAgH_3Gy3b4hrA'; // Replace with your actual YouTube Data API key
const CHANNEL_ID = 'UCX6OQ3DkcsbYNE6H8uQQuVA'; // Replace with the actual channel ID
...
function ChannelPage() {
  ...
  return (
    <div className="Main-container flex flex-col justify-center m-auto items-center mt-8 w-full py-16">
      <div className='flex justify-between items-center px-4 py-5 shadow-lg rounded-md border-2 border-gray-100'>
        <div className='flex items-center mr-8 ml-4'>
          <div>
            <img className='flex-shrink-0 w-16 rounded-full h-16 object-fill border-2 border-blue-400' src={snippet.thumbnails.default.url} alt={snippet.title} />
          </div>
          <div className='ml-6'>
        ...
        <div className='flex items-center ml-8'>
          <div>
            <img className='flex-shrink-0 w-16 rounded-full h-16 object-fill border-2 border-red-500' src="./src/assets/channels4_profile.jpg" alt="T-Series" />
          </div>
          <div className='ml-6'>
            <h2 className='text-xl font-semibold text-nowrap '>T-Series</h2>
          </div>
        ...
        <div>
          <a href={`https://livecounts.io/compare/youtube-live-subscriber-counter/${CHANNEL_ID}/youtube-live-subscriber-counter/UCq-Fj5jknLsUf-MWSy4_brA`}>
            <button className='bg-red-600 ml-4 border-2 border-black rounded-full px-8 p-3 mr-4 text-xl text-nowrap font-semibold'>Visit Live</button>
          </a>
        </div>
      </div>
      ...
      <div className='Channel-Info max-w-4xl mt-6 shadow-lg p-6 rounded-md border-2 border-gray-100'>
        <div className='flex justify-between'>
          <div className='flex items-center mr-10'>
            <div>
              <img className='w-24 rounded-md' src={snippet.thumbnails.high.url} alt={snippet.title} />
            </div>
            <div className='ml-4'>
              <div className='text-2xl font-bold'>{snippet.title}</div>
              <div className='flex items-center'>
                <div className='text-gray-500'>{snippet.customUrl}</div>
                <div className='text-sm ml-4 text-gray-400'>{statistics.videoCount} videos</div>
              </div>
            </div>
          </div>
          <div className='flex items-center'>
            <div className='mr-4 pr-6 text-center border-r-2 border-gray-400'>
              <div className='font-normal'>Subscribers</div>
              <div className='flex items-center mt-1.5'>
                <div className='font-bold mr-2'>{statistics.subscriberCount}</div>
                <div className='ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black'>#2</div>
              </div>
            </div>
            <div className='ml-4 text-center'>
              <div className='font-normal'>Total Views</div>
              <div className='flex items-center mt-1.5'>
                <div className='font-bold mr-2'>{statistics.viewCount}</div>
                <div className='ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black'>#22</div>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='flex justify-between'>
              <div className='flex justify-evenly py-7'>
                <div className='text-center rounded-md border-2 px-12 py-10 shadow-lg'>
                  <div className='font-bold'>Views</div>
                  <div>{(statistics.viewCount / 1e9).toFixed(1)}B</div> 
                  <div className='ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black'>#22</div>
                </div>
                <div className='shadow-lg rounded-md text-center ml-4 border-2 px-12 py-10'>
                  <div className='font-bold'>Subscribers</div>
                  <div>{(statistics.subscriberCount / 1e6).toFixed(1)}M</div> 
                  <div className='ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black'>#2</div>
                </div>
                <div className='shadow-lg rounded-md border-2 ml-4 text-center px-12 py-10'>
                  <div className='font-bold'>Country</div>
                  <div>{snippet.country || 'N/A'}</div> 
                  <div className='ml-2 border-2 px-6 py-1 rounded-3xl cursor-pointer text-sm font-semibold hover:text-white hover:bg-black hover:border-black'>#1</div>
                </div>
                <div className='shadow-lg rounded-md border-2 ml-4 text-center px-12 py-10'>
                  <div className='font-bold'>Category</div>
            ...
            <div className='flex justify-evenly text-center'>
              ...
              <div>
                <div className='text-sm pb-2 text-gray-600'>Channel Age</div>
                <div className='font-semibold'>{new Date().getFullYear() - new Date(snippet.publishedAt).getFullYear()} years</div>
              </div>
            </div>
            <div className='mt-4 ml-4 px-6 py-1 border-t-2'>
              <p>About</p>
